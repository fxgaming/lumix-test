...
public class RenderPleer1 implements IItemRenderer {
	...
	yw = new ResourceLocation("textures/blocks/wool_colored_yellow.png");
	...
	public void renderItem(ItemRenderType type, ItemStack is, Object... data) {
		...
		Minecraft.getMinecraft().renderEngine.bindTexture(yw);
		model.r1();
