...
public class RenderPleer3 implements IItemRenderer {
	...
	grw = new ResourceLocation("textures/blocks/wool_colored_green.png");
	...
	public void renderItem(ItemRenderType type, ItemStack is, Object... data) {
		...
		Minecraft.getMinecraft().renderEngine.bindTexture(grw);
		model.r1();
